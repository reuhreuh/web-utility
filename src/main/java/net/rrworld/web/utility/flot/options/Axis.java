...
public class Axis {
	...
	private Integer axisLabelFontSizePixels=null;
	private String axisLabelFontFamily=null;
	private String axisLabelColour=null;
	private Boolean axisLabelUseCanvas=Boolean.TRUE;
	private Boolean axisLabelUseHtml = null;
	private Integer axisLabelPadding=null;
	
	private ArrayList<Double> zoomRange = null;
	private ArrayList<Double> panRange = null;
	...
	/**
	 * @return the axisLabelColour
	 */
	public String getAxisLabelColour() {
		return axisLabelColour;
	}

	/**
	 * @param axisLabelColour the axisLabelColour to set
	 */
	public void setAxisLabelColour(String axisLabelColour) {
	 ...
	 */
	public ArrayList<Double> getZoomRange() {
		return zoomRange;
	}
	 ...
	 */
	public void setZoomRange(ArrayList<Double> zoomRange) {
	 ...
	 * @return the panRange
	 */
	public ArrayList<Double> getPanRange() {
		return panRange;
	}
	 ...
	 */
	public void setPanRange(ArrayList<Double> panRange) {
