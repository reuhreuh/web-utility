...
import net.rrworld.web.utility.flot.options.graphseries.BarsOptions;
import net.rrworld.web.utility.flot.options.graphseries.DashesOptions;
import net.rrworld.web.utility.flot.options.graphseries.LinesOptions;
import net.rrworld.web.utility.flot.options.graphseries.PieOptions;
import net.rrworld.web.utility.flot.options.graphseries.PointsOptions;
...
public class Series {
	 ...
	 * @param radius TODO
	 */
	public void setPointOptions(final Double lineWidth, final Integer radius) {
		if (points == null) {
	 ...
	 */
	public void setLineOptions(final Double lineWidth, final String fillColor) {
		if (lines == null) {
	 ...
	 * @param lineWidth TODO
	 */
	public void setLineOptions(final Double lineWidth) {
	 ...
	 * @param fillColor TODO
	 */
	public void setBarOptions(final Double lineWidth, final String fillColor) {
		if (bars == null) {
	 ...
	 * @return the dashes
	 */
	public DashesOptions getDashes() {
		return dashes;
	}
	 ...
	 */
	public void setDashes(DashesOptions dashes) {
		this.dashes = dashes;
	}
